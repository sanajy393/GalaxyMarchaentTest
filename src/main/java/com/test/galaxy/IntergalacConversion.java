...
/**
 *Test Assginment --sanjay Mishra
 *
 */
public class IntergalacConversion 
{
	private Dictionary itsDictionary;
	
	public IntergalacConversion()
	{
	...
	{
		if(!theInputValue.contains(Constants.QUESTION_MARK))
		{
        ...
        String[] strings = theInputValue.split(Constants.IS_VALUE);
        ...
        if (strings.length > 1)
        {
            ...
            if (!string.isEmpty())
            {
                ...
                StringTokenizer aTokenizer = new StringTokenizer(string, Constants.SPACE);
